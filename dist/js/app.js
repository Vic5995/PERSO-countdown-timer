...
function initDisplay() {
    ...
    timeInput.value = `${today.getHours()}:${minutes}`;
}
...
function countdown() {
    ...
    if(seconds === 0 && minutes === 0 && hours === 0 && days === 0) {
        ...
        countdownDisplay.children[3].innerHTML = seconds < 10 ? "0" + seconds : seconds;
        if (seconds === 59 && minutes !== 0) {
            minutes = --minutes < 0 && hours !== 0 ? 59 : minutes;
            countdownDisplay.children[2].innerHTML = minutes < 10 ? "0" + minutes : minutes;
        }
        if (minutes === 59 && hours !== 0) {
            hours = --hours < 0 && days !== 0 ? 23 : hours;
            countdownDisplay.children[1].innerHTML = hours < 10 ? "0" + hours : hours;
        }
        if (hours === 23 && days !== 0) {
            days = --days;
            countdownDisplay.children[0].innerHTML = days < 10 ? "0" + days : days;
        }
    }
}
...
submitBtn.addEventListener('click', ev => {
    ...
    countdownDisplay.children[1].innerHTML = hours < 10 ? "0" + hours : hours;
    countdownDisplay.children[2].innerHTML = minutes < 10 ? "0" + minutes : minutes;
    countdownDisplay.children[3].innerHTML = seconds < 10 ? "O" + seconds : seconds;
